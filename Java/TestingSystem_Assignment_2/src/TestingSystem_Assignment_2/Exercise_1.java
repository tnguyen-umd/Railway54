...
public class Exercise_1 {
	...
	public void question2(Account x) {
		...
		if (x.getGroups().length == 0) {
			System.out.println("Question 2: Nhân viên này chưa có group");
		} else if (x.getGroups().length == 1 || x.getGroups().length == 2) {
