...
CREATE TABLE Exercise2(
	...
	`Name` 			VARCHAR(100) NOT NULL, -- VARCHAR IS STORING ONLY REGULAR CHARACTERS
    `Code` 			char(5),
...
CREATE TABLE Exercise3(
	ID 					MEDIUMINT AUTO_INCREMENT PRIMARY KEY,
	Ex_Name 			NVARCHAR(50) NOT NULL, -- NVARCHAR IS USED TO STORE UNICODE CHARACTERS LIKE ARABIC, FRENCH, ETC.
    Birth_Date 			DATE NOT NULL,
